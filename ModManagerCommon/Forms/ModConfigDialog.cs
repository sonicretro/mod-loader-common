...
namespace ModManagerCommon.Forms
{
	...
	{
		string path;
		public ModConfigDialog(string path, string modname)
		{
			InitializeComponent();
			this.path = path;
			Text = "Configure Mod " + modname;
		}

		ConfigSettings settings;
		private void ModConfigDialog_Load(object sender, EventArgs e)
		{
			settings = new ConfigSettings(path);
			propertyGrid1.PropertySort = settings.ShowCategories ? PropertySort.Categorized : PropertySort.NoSort;
